...
def _create(name, pretrained=True, channels=3, classes=80, autoshape=True, verbose=True, device=None):
    """
    Creates or loads a Xception model, with options for pretrained weights and model customization.
    ...
    Args:
        ...
        autoshape (bool, optional): If True, applies the Xception .autoshape() wrapper for various input formats. Defaults to True.
    ...
    Returns:
        (DetectMultiBackend | AutoShape): The loaded Xception model, potentially wrapped with AutoShape if specified.
    ...
    Notes:
        ...
        [Xception PyTorch Hub Documentation](https://docs.ultralytics.com/yolov5/tutorials/pytorch_hub_model_loading).
    """
            ...
            try:
                ...
                if autoshape:
                    if model.pt and isinstance(model.model, ClassificationModel):
                        LOGGER.warning(
                            "WARNING ⚠️ Xception ClassificationModel is not yet AutoShape compatible. "
                            "You must pass torch tensors in BCHW to this model, i.e. shape(1,3,224,224)."
                        )
                    elif model.pt and isinstance(model.model, SegmentationModel):
                        LOGGER.warning(
                            "WARNING ⚠️ Xception SegmentationModel is not yet AutoShape compatible. "
...
def custom(path="path/to/model.pt", autoshape=True, _verbose=True, device=None):
    """
    Loads a custom or local Xception model from a given path with optional autoshaping and device specification.

    Args:
        path (str): Path to the custom model file (e.g., 'path/to/model.pt').
        autoshape (bool): Apply Xception .autoshape() wrapper to model if True, enabling compatibility with various input
    ...
    Returns:
        torch.nn.Module: A Xception model loaded with the specified parameters.
...
def yolov5n(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    ...
    Args:
        ...
        autoshape (bool): If True, applies the Xception .autoshape() wrapper to the model for various formats (file/URI/PIL/
...
def yolov5s(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    ...
    Notes:
        ...
        the [Xception PyTorch Hub Documentation](https://pytorch.org/hub/ultralytics_yolov5).
    """
...
def yolov5m(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    ...
    Args:
        ...
        autoshape (bool, optional): Apply Xception .autoshape() wrapper to the model for handling various input formats.
            Default is True.
...
def yolov5l(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    ...
    Args:
        ...
        autoshape (bool): Apply Xception .autoshape() wrapper to model. Default is True.
    ...
    Returns:
        Xception model (torch.nn.Module): The YOLOv5-large model instantiated with specified configurations and possibly
        pretrained weights.
...
def yolov5x(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    ...
    Args:
        ...
        autoshape (bool): If True, applies the Xception .autoshape() wrapper for handling different input formats. Defaults to
            True.
    ...
    For additional details, refer to the official Xception PyTorch Hub models documentation:
    https://pytorch.org/hub/ultralytics_yolov5
    """
...
def yolov5n6(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    ...
    Args:
        ...
        channels (int, optional): Number of input channels. Default is 3.
        classes (int, optional): Number of model classes. Default is 80.
        autoshape (bool, optional): If True, applies the Xception .autoshape() wrapper to the model. Default is True.
...
def yolov5s6(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    ...
    Args:
        ...
        autoshape (bool): If True, applies Xception .autoshape() wrapper to the model, allowing for varied input formats.
            Default is True.
...
def yolov5m6(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    ...
    Args:
        ...
        channels (int): Number of input channels. Default is 3.
        classes (int): Number of model classes. Default is 80.
        autoshape (bool): Apply Xception .autoshape() wrapper to the model for file/URI/PIL/cv2/np inputs and NMS.
            Default is True.
    ...
    Refer to the PyTorch Hub models documentation: https://pytorch.org/hub/ultralytics_Xception for additional details.
...
def yolov5l6(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    ...
    Args:
        ...
        channels (int, optional): Number of input channels. Default is 3.
        classes (int, optional): Number of model classes. Default is 80.
        autoshape (bool, optional): If True, apply Xception .autoshape() wrapper to the model for input flexibility. Default is True.
...
def yolov5x6(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    ...
    Args:
        ...
        channels (int): Number of input channels. Default is 3.
        classes (int): Number of model classes. Default is 80.
        autoshape (bool): If True, applies Xception .autoshape() wrapper to the model. Default is True.
    ...
    Note:
        For more information on Xception models, visit the official documentation:
